...
class Dinosaur:
    ...
    def update(self, userInput):
        ...
        if userInput[pygame.JOYBUTTONUP] and not self.dino_jump:
            self.dino_duck = False
            self.dino_run = False
            self.dino_jump = True
        elif userInput[pygame.JOYBUTTONDOWN] and not self.dino_jump:
            self.dino_duck = True
            self.dino_run = False
            self.dino_jump = False
        elif not (self.dino_jump or userInput[pygame.JOYBUTTONDOWN]):
            self.dino_duck = False
            self.dino_run = True
            self.dino_jump = False
